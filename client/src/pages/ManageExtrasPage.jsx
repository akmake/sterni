...
const fetchExtras = async () => (await api.get('/hotel-data/extras')).data;
const createExtra = (name) => api.post('/hotel-data/extras', { name });
const deleteExtra = (id) => api.delete(`/hotel-data/extras/${id}`);
