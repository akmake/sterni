            ...
            <div className="space-y-4 pt-4">
              ...
              {approvals.length > 0 && (
                <div>
                  ...
                  <div className="space-y-2">
                    {approvals.map(req => (
                      <div key={req.id} className="bg-orange-50 rounded-lg px-3 py-2 text-sm flex items-center justify-between">
                        <div>
                        ...
                        <div className="flex gap-1">
                          <button onClick={() => resolveApproval(req.id, 'approved')} className="p-1.5 bg-green-100 text-green-700 rounded hover:bg-green-200">
                            <CheckCircle size={14} />
                          </button>
                          <button onClick={() => resolveApproval(req.id, 'rejected')} className="p-1.5 bg-red-100 text-red-600 rounded hover:bg-red-200">
                            <XCircle size={14} />
                          </button>
                        </div>
                      </div>
